...
public class PortableIonCannon extends Item {
    public PortableIonCannon() {
        setFull3D();
        setMaxStackSize(1);
        setMaxDamage(100);
        setNoRepair();
        setUnlocalizedName("portable_ion_cannon");
    }
    ...
    */
    ...
    private void setStatus(ItemStack stack, boolean status) {
